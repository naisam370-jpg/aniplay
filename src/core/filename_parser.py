...
def parse_filename(filename):
    ...
    Season will always default to 1, as season detection is handled by folder structure.

    Args:
        filename (str): The base filename (e.g., "My Anime - 01 - Episode Title.mkv").

    Returns:
        dict: A dictionary containing 'title', 'episode', and 'season' (always 1).
    """
    result = {"title": None, "episode": None, "season": 1} # Season always defaults to 1
    ...
    # Pattern 2: "Anime Title S01E01" or "Anime Title E01" - now only extract episode
...
if __name__ == '__main__':
    test_filenames = [
        ...
        "Another.Anime.S01E05.Title.mkv", # Should get episode 5, season 1
        ...
        "Boku no Hero Academia S6 - 25.mkv", # Should get episode 25, season 1
        "Anime Title Season 2 Episode 10.mp4", # Should get episode 10, season 1
        "Anime.Title.S03.E01.mkv", # Should get episode 1, season 1
